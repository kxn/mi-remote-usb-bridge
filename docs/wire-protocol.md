...
联通键目录新增稳定 ID：0x0013 Settings、0x0014 Local、0x0015 ChannelUp、0x0016 ChannelDown、0x0017–0x0020 Digit0–Digit9、0x0021 Star、0x0022 Hash。目录槽位仍由 KEY_CATALOG 返回。

FIND 可返回广播 HIDS 的待检查候选（support=0），不再只依赖已知型号名称；用户选择后通过 GATT 与报文确认。候选 ID 保持稳定，无名称更新不抹掉已取得名称。候选不等于已支持的遥控器。
